...
| The flip (stage 5) | boot constants, native runner, verification switch | full demo corpus passes native-vs-VM tick-by-tick; zero interpreted instructions in the hot path |
